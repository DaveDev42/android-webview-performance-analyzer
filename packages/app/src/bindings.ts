...
const ARGS_MAP = { 'api':'{"connect_cdp":["ws_url"],"create_session":["params"],"delete_session":["session_id"],"disconnect_cdp":[],"end_session":["session_id"],"get_cdp_state":[],"get_cdp_targets":["port"],"get_devices":[],"get_performance_metrics":[],"get_session":["session_id"],"get_session_metrics":["session_id","metric_type","start_time","end_time","limit"],"get_session_network_requests":["session_id","limit"],"get_webviews":["device_id"],"list_sessions":["limit"],"start_metrics_collection":["poll_interval_ms"],"start_port_forward":["device_id","socket_name","local_port"],"stop_all_port_forwards":["device_id"],"stop_metrics_collection":[],"stop_port_forward":["device_id","local_port"]}' }
